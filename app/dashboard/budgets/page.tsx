...
export default function BudgetsPage() {
  ...
  const fetchBudgetData = useCallback(async () => {
    ...
    try {
      ...
      const nextMonth = localNow.getMonth() === 11 ? 0 : localNow.getMonth() + 1;
      const nextYear = localNow.getMonth() === 11 ? localNow.getFullYear() + 1 : localNow.getFullYear();
      ...
      console.error("Error loading budgets details:", err);
    } finally {
      setLoading(false);
    }
